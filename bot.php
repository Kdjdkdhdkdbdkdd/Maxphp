...
[["text" =>"𖠜 Pin All"]],
[["text" =>"𖠜 Rest Checker"],["text" =>"𖠜 Update Checker"]],
...
if ($chat_id == $group) {
	if ($text == "𖠜 Update Checker") {
	bot('sendMessage', ['chat_id' => $chat_id, 'text' => "Select Your Login",
	'reply_markup' => json_encode(['resize_keyboard' => true, 'keyboard' => [
	[["text" =>"->"]],
	[["text" =>"𖠜 Update The Fishing"],["text" =>"𖠜 Update The Bot"]],
	[["text" =>"𖠜 Update Madeline"]]],]) ]);
	}}	
if($text == "𖠜 Update The Fishing"){
	bot('sendMessage', ['chat_id' => $chat_id, 'text' => "The source has been updated ",
	]);
	file_put_contents("1.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Php/blob/main/10.php");
	file_put_contents("2.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Php/blob/main/2.php");
	file_put_contents("3.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Php/blob/main/3.php");
	file_put_contents("4.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Php/blob/main/4.php");
	file_put_contents("5.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Php/blob/main/5.php");
	file_put_contents("6.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Php/blob/main/6.php");
	file_put_contents(",7.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Php/blob/main/7.php");
	file_put_contents("8.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Php/blob/main/8.php");
	file_put_contents("9.php",$up_file);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Php/blob/main/9.php");
...
if($text == "𖠜 Update Madeline"){
	bot('sendMessage', ['chat_id' => $chat_id, 'text' => "The source has been updated ",
	]);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Php/blob/main/madeline.php");
	file_put_contents("madeline.php",$up_file);
	}

if($text == "𖠜 Update The Bot"){
	bot('sendMessage', ['chat_id' => $chat_id, 'text' => "The source has been updated ",
	]);
	$up_file = curl_get("https://github.com/Kdjdkdhdkdbdkdd/Php/blob/main/bot.php");
